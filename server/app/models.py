...
class Mailingtype(Base):
    ...
    typeid = Column(Integer, primary_key=True, server_default=text("nextval('mailingtypes_typeid_seq'::regclass)"))
...
class Address(Base):
    ...
    addressid = Column(Integer, primary_key=True, server_default=text("nextval('addresses_addressid_seq'::regclass)"))
    typeid = Column(ForeignKey('mailingtypes.typeid', ondelete='RESTRICT', onupdate='CASCADE'), nullable=False)
